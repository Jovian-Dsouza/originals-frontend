...
const CollabFeed = () => {
  ...
  const filteredCollabs = collabs.filter(collab => !removedCardIds.has(collab.id));
  ...
  const handleSwipe = (direction: 'left' | 'right') => {
    ...
    setTimeout(() => {
      ...
      setRemovedCardIds(prev => new Set([...prev, currentCollab.id]));
  ...
  const handleTouchStart = (e: React.TouchEvent) => {
    ...
    const handleTouchMove = (e: TouchEvent) => {
      ...
      if (Math.abs(deltaX) > Math.abs(deltaY) && Math.abs(deltaX) > 10) {
        setCardOffset(deltaX * 0.6); // Slightly more responsive movement
  ...
  return (
    <div className="min-h-screen pb-24 bg-background overflow-hidden">
      ...
      <main className="max-w-md mx-auto p-4 pb-20 min-h-[calc(100vh-250px)] flex items-center justify-center overflow-hidden">
        {!isConnected ? (
          ...
          <div className="relative w-full max-w-sm mx-auto aspect-[3/4] max-h-[600px]">
            ...
            {filteredCollabs.slice(currentIndex, currentIndex + 2).map((collab, index) => (
              <div
                ...
                style={{
                  ...
                  opacity: index === 0 && Math.abs(cardOffset) > 100 ? 0.7 : undefined,
              ...
              >
                ...
                <div className="relative h-3/5">
                  ...
                  {/* Swipe indicators */}
                  {index === 0 && Math.abs(cardOffset) > 50 && (
                    <>
                      {cardOffset > 0 && (
